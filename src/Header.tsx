...
export default function Header() {
  return (
    <div className="lg:w-80 sm:w-64 p-8 sm:pt-16 pb-4">
      <p className="font-noto font-bold text-2xl sm:pb-8 pb-4">{config.title}</p>
    
      <div className="font-lato text-[#6b747a]">
        {config.description && <p className="sm:pb-8 pb-4" dangerouslySetInnerHTML={{__html: config.description}} />}
